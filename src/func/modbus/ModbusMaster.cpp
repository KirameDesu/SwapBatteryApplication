...
@ingroup setup
*/
ModbusMaster::ModbusMaster(Stream* serial)
{
    _idle = 0;
    _preTransmission = 0;
    _postTransmission = 0;
...
void ModbusMaster::sendBit(bool data)
{
    ...
    if ((u16TransmitBufferLength >> 4) < ku8MaxBufferSize)
    {
        ...
        CustomStream::bitWrite(_u16TransmitBuffer[_u8TransmitBufferIndex], txBitIndex, data);
...
uint8_t ModbusMaster::ModbusMasterTransaction(uint8_t u8MBFunction)
{
    ...
    case ku8MBReadWriteMultipleRegisters:
        u8ModbusADU[u8ModbusADUSize++] = CustomStream::highByte(_u16ReadAddress);
        u8ModbusADU[u8ModbusADUSize++] = CustomStream::lowByte(_u16ReadAddress);
        u8ModbusADU[u8ModbusADUSize++] = CustomStream::highByte(_u16ReadQty);
        u8ModbusADU[u8ModbusADUSize++] = CustomStream::lowByte(_u16ReadQty);
        break;
    }
    ...
    case ku8MBReadWriteMultipleRegisters:
        u8ModbusADU[u8ModbusADUSize++] = CustomStream::highByte(_u16WriteAddress);
        u8ModbusADU[u8ModbusADUSize++] = CustomStream::lowByte(_u16WriteAddress);
        break;
    }
    ...
    {
    case ku8MBWriteSingleCoil:
        u8ModbusADU[u8ModbusADUSize++] = CustomStream::highByte(_u16WriteQty);
        u8ModbusADU[u8ModbusADUSize++] = CustomStream::lowByte(_u16WriteQty);
        break;

    case ku8MBWriteSingleRegister:
        u8ModbusADU[u8ModbusADUSize++] = CustomStream::highByte(_u16TransmitBuffer[0]);
        u8ModbusADU[u8ModbusADUSize++] = CustomStream::lowByte(_u16TransmitBuffer[0]);
        break;
    ...
    case ku8MBWriteMultipleCoils:
        ...
        for (i = 0; i < u8Qty; i++)
        {
            ...
            {
            case 0: // i is even
                u8ModbusADU[u8ModbusADUSize++] = CustomStream::lowByte(_u16TransmitBuffer[i >> 1]);
                break;

            case 1: // i is odd
                u8ModbusADU[u8ModbusADUSize++] = CustomStream::highByte(_u16TransmitBuffer[i >> 1]);
                break;
            }
        }
        break;
    ...
    case ku8MBReadWriteMultipleRegisters:
        u8ModbusADU[u8ModbusADUSize++] = CustomStream::highByte(_u16WriteQty);
        u8ModbusADU[u8ModbusADUSize++] = CustomStream::lowByte(_u16WriteQty);
        u8ModbusADU[u8ModbusADUSize++] = CustomStream::lowByte(_u16WriteQty << 1);

        for (i = 0; i < CustomStream::lowByte(_u16WriteQty); i++)
        {
            u8ModbusADU[u8ModbusADUSize++] = CustomStream::highByte(_u16TransmitBuffer[i]);
            u8ModbusADU[u8ModbusADUSize++] = CustomStream::lowByte(_u16TransmitBuffer[i]);
        }
        break;
    ...
    case ku8MBMaskWriteRegister:
        u8ModbusADU[u8ModbusADUSize++] = CustomStream::highByte(_u16TransmitBuffer[0]);
        u8ModbusADU[u8ModbusADUSize++] = CustomStream::lowByte(_u16TransmitBuffer[0]);
        u8ModbusADU[u8ModbusADUSize++] = CustomStream::highByte(_u16TransmitBuffer[1]);
        u8ModbusADU[u8ModbusADUSize++] = CustomStream::lowByte(_u16TransmitBuffer[1]);
        break;
    }
    ...
    u8ModbusADU[u8ModbusADUSize++] = CustomStream::lowByte(u16CRC);
    u8ModbusADU[u8ModbusADUSize++] = CustomStream::highByte(u16CRC);
    ...
    while (u8BytesLeft && !u8MBStatus)
    {
        ...
        if (u8ModbusADUSize == 5)
        {
            ...
            if (CustomStream::bitRead(u8ModbusADU[1], 7))
            {
    ...
    if (!u8MBStatus && u8ModbusADUSize >= 5)
    {
        ...
        // verify CRC
        if (!u8MBStatus && (CustomStream::lowByte(u16CRC) != u8ModbusADU[u8ModbusADUSize - 2] ||
            CustomStream::highByte(u16CRC) != u8ModbusADU[u8ModbusADUSize - 1]))
        {
    ...
    if (!u8MBStatus)
    {
        ...
        case ku8MBReadDiscreteInputs:
            ...
            for (i = 0; i < (u8ModbusADU[2] >> 1); i++)
            {
                ...
                {
                    _u16ResponseBuffer[i] = CustomStream::word(u8ModbusADU[2 * i + 4], u8ModbusADU[2 * i + 3]);
                }
            ...
            if (u8ModbusADU[2] % 2)
            {
                if (i < ku8MaxBufferSize)
                {
                    _u16ResponseBuffer[i] = CustomStream::word(0, u8ModbusADU[2 * i + 3]);
                }
        ...
        case ku8MBReadWriteMultipleRegisters:
            ...
            for (i = 0; i < (u8ModbusADU[2] >> 1); i++)
            {
                if (i < ku8MaxBufferSize)
                {
                    _u16ResponseBuffer[i] = CustomStream::word(u8ModbusADU[2 * i + 3], u8ModbusADU[2 * i + 4]);
                }
